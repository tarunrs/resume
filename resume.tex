...
\address{Total experience: 12 years}{Bangalore, India}    % optional, remove the line if not wanted
...
\cventry{2019 -- Present}{Technical lead}{Vahan Inc}{Bangalore, India}{}{ Responsible for backend engineering and mentoring of team members.\newline
\emph{Highlights:}
\begin{itemize}
\item \textbf{} Improved database read time by 2.5x on a very large table by using table inheritance and table partitioning
\item \textbf{} Implemented a easily scalable system for websockets increasing throughput by 2x
\item \textbf{} Made the internal jobs system more robust by using Apache Airflow reducing failure rate from 20\% to 2\%.
\item \textbf{} Dockerized all products and improved the process of deployment with automated tests.
\item \textbf{} Implemented HA on all products to achieve an uptime of 99.5\%
\item \textbf{} Architected and implemented the backend for the Mitra product
\item \textbf{} Build a rule based cohort generation system with custom query generation
\item \textbf{} Performed database and query optimizations to reduce query time by orders of magnitude
\end{itemize}}
...
\cvitem{Languages}{\small Experience: Python, Javascript, C\newline Intermediate: HTML/CSS, Java, C++\newline Familiar with distributed/parallel processing systems like Spark, MapReduce/Hadoop ecosystem}
\cvitem{Datastores}{\small Postgres, MongoDb, DynamoDb, Elasticsearch, HBase }
\cvitem{Datastores}{\small Flask, Node, ExpressJS, NestJs, Django}
